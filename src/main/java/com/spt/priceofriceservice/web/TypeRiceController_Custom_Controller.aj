...
privileged aspect TypeRiceController_Custom_Controller {
    

    
    @RequestMapping(value = "/typericeInsert", method = RequestMethod.GET,produces = "text/html")
    public String TypeRiceController.typericeInsert(Model uiModel) {
        
        return "typerices/typericeInsert";
    }    
}
